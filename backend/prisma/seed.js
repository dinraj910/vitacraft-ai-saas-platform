...
async function main() {
  ...
  const plans = [
    ...
    },
    {
      ...
      monthlyCredits: 50,
      priceUSD: 9.99,
      stripePriceId: process.env.STRIPE_PRICE_PRO || 'price_1T67MHKiI4vJwdgAoH00qkmD',
    ...
    },
    {
      ...
      monthlyCredits: 200,
      priceUSD: 29.99,
      stripePriceId: process.env.STRIPE_PRICE_ENTERPRISE || 'price_1T67NWKiI4vJwdgAnJSMc8Cv',
